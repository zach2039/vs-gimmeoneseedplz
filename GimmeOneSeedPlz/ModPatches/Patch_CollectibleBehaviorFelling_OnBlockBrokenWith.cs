...
namespace GimmeOneSeedPlz.ModPatches
{
	...
	class Patch_CollectibleBehaviorFelling_OnBlockBrokenWith
	{
		...
		static void Postfix(CollectibleBehaviorFelling __instance, ref Tuple<Block, Stack<BlockPos>> __state, IWorldAccessor world, Entity byEntity, ItemSlot itemslot, BlockSelection blockSel, float dropQuantityMultiplier, ref EnumHandling handled)
		{
